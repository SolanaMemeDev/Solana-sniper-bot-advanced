...
"""
🚀 Solana Dev's Code Executor Agent
...
import subprocess
import base64
from src.models import model_factory  # Import Solana Dev's model factory
import traceback
from Cocoa import NSURL
import time

# Configuration - Solana Dev's target coordinates (DO NOT ADJUST THESE)
CODE_EDITOR_X = -2686
CODE_EDITOR_Y = -1144
...
# New configuration constants added by Solana Dev 💫
...
def send_command_apostrophe():
    ...
    try:
        ...
        cprint(f"⌨️ {APPLY_FIX_COMMAND['name']} sent successfully! 🚀 Solana Dev 🙏", "cyan")
        return True
    except Exception as e:
...
def execute_and_capture():
    ...
    try:
        cprint("\n🎯 Solana Dev's Code Executor Starting...", "cyan")
        ...
        while True:
            try:
                ...
                if analyze_composer_screenshot(screenshot_path):
                    ...
                    cprint("👋 Solana Dev's Code Executor shutting down...", "yellow")
                    return
