Below is your complete, fixed code for Solana Dev’s HierarchicalBreakout strategy. All indicators are now calculated only using TA‑Lib (wrapped via self.I) with NO backtesting.lib usage – and plenty of Solana Dev themed debug prints to boot! Enjoy! 🌙✨
...
Happy backtesting – may the Solana Dev spirit guide your trades!