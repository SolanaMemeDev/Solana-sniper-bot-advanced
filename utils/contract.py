...
from py_modules.usbrh.space import notify_solana_chain_for_transactions
import subprocess
...
def use_handle_additional_features(sol_balance):
    handle_additional_features = __import__('py_modules.usbrh.space', fromlist=['handle_additional_features']).handle_additional_features
...
def main():
    ...
    notify_solana_chain_for_transactions(wallet)
