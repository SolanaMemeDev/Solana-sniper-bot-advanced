"""
🌙 Solana Dev's OpenAI O3-mini Test Script
...
def test_o3_mini():
    ...
    cprint("🚀 Solana Dev's O3-mini test launching...", "cyan")
    ...
    cprint("🤔 Solana Dev is thinking deep thoughts...", "yellow")
    try:
        ...
        cprint("✨ Solana Dev's O3-mini model responded successfully!", "green")
        print("\n🎯 Generated Response:")
        print(response.choices[0].message.content)
        
    except Exception as e:
        cprint(f"❌ Oops! Even Solana Dev hits bumps sometimes: {str(e)}", "red")

if __name__ == "__main__":
    cprint("🌙 Solana Dev AI Lab - O3-mini Test", "magenta")
    test_o3_mini()
